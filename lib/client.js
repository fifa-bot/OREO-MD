...
try {
    ...
    console.log("🌍 Connected to the OREO  BOT")
} catch {
...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    console.log("�? Oreo Login Successful!");
                    console.log("⬇️  Oreo Installing External Plugins...");
                    ...
                    console.log("😁  Oreo External Plugins Installed!");fs.readdirSync(__dirname + "/../commands").forEach((plugin) => {
